...
**START BY EXPLORING AUTONOMOUSLY:** Immediately begin exploring the codebase at https://github.com/kga245/writers-room to gather product information. Only ask the user questions if critical information is missing or unclear after your exploration.
...
2. **If product URL found, fetch it immediately:**
   - URL is https://writersrooms.studio/
